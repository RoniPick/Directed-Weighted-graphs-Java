...
class GraphAlgorithmsTest {
    ...
    void isConnected() {
        ...
        g.load("C:\\Java Projects\\Ex2_OOP\\src\\data\\100000Nodes.json");
        assertTrue(g.isConnected());
    ...
    void shortestPathDist() {
        ...
        g.load("C://Java Projects//Ex2_OOP//src//data//10000Nodes.json");
        double ans7 = g.shortestPathDist(1,12);
        assertNotEquals(5,ans7);

        g.load("C://Java Projects//Ex2_OOP//src//data//100000Nodes.json");
        double ans5 = g.shortestPathDist(1,12);
        assertNotEquals(5,ans5);
    }
    ...
    void shortestPath() {
        ...
        g.load("C://Java Projects//Ex2_OOP//src//data//10000Nodes.json");
        List <NodeData> ans9 = g.shortestPath(1,14);
        assertNotEquals(5,ans9.size());

        g.load("C://Java Projects//Ex2_OOP//src//data//100000Nodes.json");
        List <NodeData> ans10 = g.shortestPath(1,14);
        assertNotEquals(5,ans10.size());
    ...
    void center() {
        ...
        assertNotEquals(3846, n5.getKey());

        g.load("C:\\Java Projects\\Ex2_OOP\\src\\data\\G3.json");
        NodeData no5 = g.center();
        assertEquals(40, no5.getKey());
    }
    ...
    void tsp() {
        ...
        g.load("C://Java Projects//Ex2_OOP//src//data//100000Nodes.json");
        NodeData a = g.getGraph().getNode(1);
        NodeData b = g.getGraph().getNode(2);
        NodeData c = g.getGraph().getNode(13);
        NodeData d = g.getGraph().getNode(17);
        NodeData e = g.getGraph().getNode(25);
        NodeData f = g.getGraph().getNode(17);
        NodeData k = g.getGraph().getNode(35);
        NodeData h = g.getGraph().getNode(147);
        NodeData i = g.getGraph().getNode(323);
        NodeData j = g.getGraph().getNode(323);
    ...
    @Test
    void load() {
        assertTrue(g.load("C://Java Projects//Ex2_OOP//src//data//1000Nodes.json"));

        assertTrue(g.load("C:\\Java Projects\\Ex2_OOP\\src\\data\\10000Nodes.json"));
